		      ...
		      )
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////////
  // Trkr cluster
  Fun4AllInputManager *in_cluster = new Fun4AllDstInputManager( "DST_input_cluster" );
  //  string data_cluster = "DST_TRKR_CLUSTER_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000019-000000.root";
  //  in_cluster->fileopen( data_cluster );
  in_cluster->AddListFile( "list_MDC2_AuAu_run19_TrkrCluster.txt" ); // to read a list of files, use it. A path to the text file needs to be given.  
  se->registerInputManager( in_cluster );

  // MBD
  Fun4AllInputManager *in_mbd = new Fun4AllDstInputManager( "DST_input_mbd" );
  //  string data_mbd = "DST_MBD_EPD_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000019-000000.root";
  //  in_mbd->fileopen( data_mbd );
  in_mbd->AddListFile( "list_MDC2_AuAu_run19_MBD.txt" ); // to read a list of files, use it. A path to the text file needs to be given.
  
  se->registerInputManager( in_mbd );
