...
int Fun4All_minimum_6(
		     int nEvents = 10, //5,
		     const string &inputFile = "/sphenix/tg/tg01/commissioning/INTT/data/dst_files/2023/test/test_DST_beam_intt_00020869_10events.root",
		     ...
		     )
{
  ...
  // Fun4AllOutputManager* out = new Fun4AllDstOutputManager("DST", "output.root" );
